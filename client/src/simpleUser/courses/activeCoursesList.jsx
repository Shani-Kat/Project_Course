...
import { useGetActiveCoursesQuery, useGetCourseByKategoriesQuery } from "./courseApiSlice";
...
export default function ActiveCourseList() {
  ...
  const {data: courses, isLoading, isError, error} = useGetActiveCoursesQuery(location.state.id)
